...
<ul>
<cfif P gt 1>	
<li><a href="#cgi.script_name#/#urldecode(qstr)#/p/#int(url.p - 1)#/st/#st#" class="prev">
#Attributes.Previous#</a></li>
</cfif>
...
<cfif Attributes.recordcount gt Attributes.perPage>
	...
	<cfset st = (i * attributes.perpage)-attributes.perpage+1>
		<li><a href="#cgi.script_name#/#urldecode(qstr)#/p/#i#/st/#st#" <cfif i eq P>class="cpage"<cfelse>class="page"</cfif>>#i#</a></li>
	</cfloop>
</cfif>


<cfif int(P * Attributes.perPage) lt Attributes.recordcount>	
	<li><a href="#cgi.script_name#/#urldecode(qstr)#/p/#int(P + 1)#/st/#st#" class="next">#Attributes.Next#</a></li>
</cfif>
</ul>
</div>
