...
<cfset url.sb = session.sb>
	...
	<cfscript>
     args = structNew();
     args.keywords = url.kw;
	 args.location = url.l;
	 args.radius = url.radius;
	 args.page = url.p;
	 args.sb = url.sb;
	 </cfscript>
    

    <cfinvoke component="#request.componentpath#.SimplyHired" method="renderJobs" argumentcollection="#args#" returnvariable="jobdata">
   <!--- <cfobject name="application.Jobs" component="#request.componentpath#.GetJobs">    --->
   
<cfoutput>#jobdata#</cfoutput>
   ...
   <cfabort>
    ...
    <cfinvoke component="#request.componentpath#.GetSimplyHiredJobs" method="getjob" jobid="#url.jobid#" returnvariable="jobdata">
    ...
    <cfelse>
    <cfinvoke component="#request.componentpath#.GetSimplyHiredJobs" method="getjobs" argumentcollection="#url#" returnvariable="jobdata">
	...
	<cfif isdefined('jobdata.recordcount') and jobdata.recordcount gt 2>
		<!--- sub queries "filters" --->   
        <cfinvoke component="#request.componentpath#.gGetSimplyHiredJobs" method="getlocations" myquery="#jobdata#" returnvariable="locations">
        ...
        <cfinvoke component="#request.componentpath#.GetSimplyHiredJobs" method="getEmployers" myquery="#jobdata#" returnvariable="employers">
