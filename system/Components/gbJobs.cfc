<cfcomponent output="yes">
	...
	<cffunction name="getJobs" access="public" returntype="query" hint="I make a cfhttp query call to googlebase for jobs parse the XML format it and return it  as a string variable.">
	...
	if (arguments.sb is "d")
	variables.sb = "modification_time"; //sort by 
	else
	variables.sb = "relevancy";
	</cfscript>
	...
	<cfif isdefined('arguments.kw') and len(arguments.kw)>
        ...
        <cfif isdefined('arguments.emp') and len(arguments.emp)>
    		<cfif arguments.kw eq 'in'><cfset variables.bq = "bq="></cfif>
        <cfelse>
        	<cfset variables.bq = variables.bq &''& variables.kw>
        </cfif> 
        <!--- --------------------------------------------- --->
	...
	<cfif isDefined('url.test') and url.test is "g">
	<cfoutput>
...
--->	
	...
	<cffunction name="xml2Query" access="public" hint="I convert the goolglebase XML to a memory query">
...
<cfif structkeyexists(xml.feed.entry[i], "link")>
	...
	<cffunction name="getLocations" access="public" returntype="query" hint="">
    ...
    <cffunction name="getJobIndustry" access="public" returntype="query"  hint="">
	<cfargument name="myquery" type="query" required="no">
	<cfif isDefined('arguments.myquery')>
	...
	<cffunction name="getSource" access="public" returntype="query"  hint="">
	<cfargument name="myquery" type="query" required="no">
	<cfif isDefined('arguments.myquery')>
	...
	<cffunction name="getEmployers" access="public" returntype="query"  hint="">
	<cfargument name="myquery" type="query" required="no">
	<cfif isDefined('arguments.myquery')>
	...
	<cffunction name="getSalarys" access="public" returntype="query"  hint="">
	<cfargument name="myquery" type="query" required="no">
	<cfif isDefined('arguments.myquery')>
	 <cfquery dbtype="query" name="employer">
	...
	<cffunction name="getDescription" access="public" returntype="query" hint="">
	<cfargument name="myquery" type="query" required="no">
	<cfif isDefined('arguments.myquery')>
	 <cfquery dbtype="query" name="desc" maxrows="2" cachedwithin="#createtimespan(0,0,0,0)#">
