...
<cffunction name="getJobs" access="public" output="no" returntype="query">
	...
	<cfargument name="re" type="string" default="1" hint="row end (1-500)">
...
<cfhttp url="http://www.jobcentral.com/api.asp?key=iouhbqerwiytfdwqlohiroi&cname=#urlencodedFormat(arguments.co)#&kw=#arguments.kw#&so=#arguments.so#&i=#arguments.i#&rs=#rs#">
