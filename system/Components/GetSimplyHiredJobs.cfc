<cfcomponent>
    ...
    <!---
    <cfset variables.publisher = "4868123056500420">
    <cfset variables.publisher = "3384564181756091">
    --->
    
    <cfset variables.publisher = "372305085978393">

	
    
	<cfset variables.publisher = "4381236808151123">
    
    <cfset variables.publisher = "4156307376013207">
...
<!--- SIMPLY HIRED API --->
<cfset link="http://api.simplyhired.com/a/jobs-api/xml-v2/q-#kw#/l-#l#/ws-100/pn-#page/mi-#radius#/sb-#sb#?pshid=25886&ssty=2&cflg=r&jbd=jobfool.jobamatic.com/clip-#cgi.REMOTE_ADDR#">

		http://api.simplyhired.com/a/jobs-api/xml-v2/'q-' . $onet_filter . $this->query . '/l-' . $this->location . '/ws-' . $number . '/pn-' . $this->pagenum . '/sb-dd?pshid=' . $this->pshid .  $ssty . '&cflg=r&jbd=' . $this->jbd . '&clip=' . $this->clip;
