...
<html lang="en">
    ...
    <body>
        ...
        The Job Fool can help. We've aggregated jobs from thousands of sources and made them available from one centralized job site.<br><br><span class="red">No foolin around!</span> Now your job search can be simplified.</p>
                ...
                <p>One of the biggest challenges of running a business is finding and hiring good employees. Itï¿½s difficult to know where to turn when you have a job opening that you need to fill. We offer solutions that allow you to maximize your recruitment advertising efforts and services that help you research the best candidates, post your job to us as well as multiple job sites we network with.
        The Job Fool helps connect third-party recruiters to the best candidates. Through our partnership with JobTarget and their exclusive relationships with over 1000 specialty associations and organizations, we can access candidates that are not posting their resume into Monster or CareerBuilder. Our risk-free resume banks, sourcing technology, and job board technology are used by recruiters to get an edge.<br><br><span class="red">No foolin around!</span> The Job Fool can help!</p>
            </div>             
        </div>
